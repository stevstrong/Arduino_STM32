...
WS2812B::WS2812B(uint16_t number_of_leds) :
  begun(false), brightness(0), pixels(NULL), doubleBuffer(NULL)
{
...
{
  SPI.dmaSend(pixels,numBytes);// Start the DMA transfer of the current pixel buffer to the LEDs and return immediately.
